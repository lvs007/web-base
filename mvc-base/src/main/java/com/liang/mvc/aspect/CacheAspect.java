...
import com.liang.mvc.annotation.cache.RedisCacheAnnotation;
...
public class CacheAspect {
    ...
    @Around("execution(* * (..)) && (@annotation(com.liang.mvc.annotation.cache.TairCacheAnnotation) " +
            "|| @annotation(com.liang.mvc.annotation.cache.LocalCacheAnnotation) " +
            "|| @annotation(com.liang.mvc.annotation.cache.RedisCacheAnnotation))")

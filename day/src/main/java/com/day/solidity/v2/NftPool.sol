...
contract IERC721 {
    ...
    function nftdesc(uint96 nftId) public view returns (address owner, uint8 level);
...
contract LPTokenWrapper {
    ...
    mapping(address => uint96) private _nfts;
    ...
    function _stake(uint256 amount, uint96 nftId) internal {
...
contract MHPool is LPTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount, uint96 nftId) public updateReward(msg.sender) checkStart {

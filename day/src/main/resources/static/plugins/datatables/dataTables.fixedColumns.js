...
$.extend( FixedColumns.prototype , {
	...
	"_fnConstruct": function ( oInit )
	{
        ...
        $('.' + classes.sScrollBody).axScroll();//AXUI
	...
	"_fnGridSetup": function ()
	{
        ...
        $(".DTFC_ScrollWrapper").before('<div class="ax-clear"></div><div class="ax-break"></div>');//AXUI
        $(".DTFC_ScrollWrapper").after('<div class="ax-break"></div><div class="ax-clear"></div>');//AXUI
		...
		if ( this.s.iRightColumns > 0 )
		{
			...
			nRight.style.right = 0;//AXUI

			block = $('div.DTFC_RightHeadBlocker', nSWrapper)[0];
			block.style.width = 0;//AXUI
			block.style.right = 0;//AXUI

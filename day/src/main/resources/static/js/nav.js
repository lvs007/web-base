var navBar = document.querySelector('.ax-nav');
var menu = document.querySelectorAll('.ax-nav li');
...
function calcTop(recalNav) {
  ...
  var contents = ['content1', 'content2', 'content3', 'content4', 'content5', 'content6', 'content7'];
...
function selectNav(e) {
  ...
  this.resetNavSelect();
  target.className = 'ax-active';
//  scrollContainer.scrollTop = offsetTops[target.getAttribute('data-content')] - extraScroll;
  window.scrollY = offsetTops[target.getAttribute('data-content')] - extraScroll;
}
...
function validateSticky () {
  ...
  if (supportStickyValue) {
    var navBarWrap = document.querySelector('.ax-nav');
...
//    menu[menuLength - 1].className += ' ax-active';
//    return;
//  }
